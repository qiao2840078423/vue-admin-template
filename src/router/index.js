...
>>>>>>> 18c14c2988978318652ce87c0d74b6d934ebe852
      ...
      },
      {
        ...
        component: () => import('@/views/datamanage/search'),
        hidden: true
      }
    ]
  },
        ...
        children: [
          {
            path: 'topology',
            name: 'Topology',
            component: () => import('@/views/picture/graph/topology'),
            meta: { title: '流域拓补图', icon: 'tree' }
          },
          {
            path: 'satellite',
            name: 'Satellite',
            component: () => import('@/views/picture/graph/satellite'),
            hidden: true
          }
        ]
=======
