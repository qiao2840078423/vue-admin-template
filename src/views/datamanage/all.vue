<template>
  <div class="dashboard-editor-container">
    <el-form :inline="true" :model="formInline">
      ...
      <el-form-item label="类别" class="form-inline">
        <el-select v-model="formInline.type" placeholder="请输入类别">
...
export default {
  ...
  methods: {
    ...
    onSearch() {
      ...
      this.tableData = tableData.filter(obj => {
        return type === '' ? obj.name.includes(name) : obj.name.includes(name) && obj.type === type
      })
      this.$message({
        message: "搜索成功！",
        type: "success",
